 ...
 * - Mobile/Tablet Top Header Hamburger Menu (md:hidden)
 * - Mobile/Tablet Responsive Slide-Out Drawer Navigation with Auto-Close on Navigation
 */
        ...
        <header className="bg-white border-b border-gray-200 h-16 px-4 sm:px-6 flex items-center justify-between sticky top-0 z-30 shadow-2xs">
          ...
          <div className="flex items-center gap-3 shrink-0">
            ...
            <div className="text-left text-xs hidden sm:block">
              <p className="font-bold text-gray-900 leading-tight truncate max-w-[120px]">{user?.name}</p>
